...
const orderService = {
  ...
  async completedOrdersComparison() {
    try {
      ...
      // Xác định tháng trước (last month)
      ...
      // Xác định tháng trước nữa (previous month)
      ...
      // Lấy số đơn hàng của tháng trước
      ...
      // Lấy số đơn hàng của tháng trước nữa
      ...
      const changePercentage = prevMonthOrders
        ? ((lastMonthOrders - prevMonthOrders) / prevMonthOrders) * 100
        : 0; // Tránh chia cho 0 nếu tháng trước đó không có đơn nào
      ...
      console.error(
        "An error occurred while fetching completed orders:",
        error
      );
